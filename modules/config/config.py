...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " LUCKY MUSIC PLAYER")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5636795150").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/ITS-LUCKY-BOY",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Lucky")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/WorldFriends_143")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/DX_INFO")
